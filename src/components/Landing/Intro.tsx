  ...
  return (
    ...
    >
      ...
      <div ref={textRef} className="z-10 text-center px-6">
        <h1 className="sticky text-3xl md:text-7xl font-bold tracking-tight">
